...
var templateSpecs = []templateSpec{
	...
	{Source: "templates/base/main.go.tmpl", Path: "cmd/api/main.go", Mode: 0o644, Ownership: OwnershipUser},
	...
	{Source: "templates/base/bootstrap.go.tmpl", Path: "internal/bootstrap/app.go", Mode: 0o644, Ownership: OwnershipUser},
	{Source: "templates/base/router.go.tmpl", Path: "internal/infrastructure/http/router.go", Mode: 0o644, Ownership: OwnershipUser},
	{Source: "templates/base/router_test.go.tmpl", Path: "internal/infrastructure/http/router_test.go", Mode: 0o644, Ownership: OwnershipUser},
	...
	{Source: "templates/postgres/pool.go.tmpl", Path: "internal/infrastructure/persistence/postgres/pool.go", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/transaction.go.tmpl", Path: "internal/infrastructure/persistence/postgres/transaction.go", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/timestamp.go.tmpl", Path: "internal/infrastructure/persistence/postgres/timestamp.go", Mode: 0o644, Ownership: OwnershipGenerated, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/order_repository.go.tmpl", Path: "internal/infrastructure/persistence/postgres/order_repository.go", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/sqlc_db.go.tmpl", Path: "internal/generated/sqlc/db.go", Mode: 0o644, Ownership: OwnershipGenerated, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/sqlc_models.go.tmpl", Path: "internal/generated/sqlc/models.go", Mode: 0o644, Ownership: OwnershipGenerated, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/sqlc_orders.go.tmpl", Path: "internal/generated/sqlc/orders.sql.go", Mode: 0o644, Ownership: OwnershipGenerated, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	...
	{Source: "templates/postgres/orders.sql.tmpl", Path: "db/queries/orders.sql", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/sqlc.yaml.tmpl", Path: "sqlc.yaml", Mode: 0o644, Ownership: OwnershipGenerated, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	...
	{Source: "templates/postgres/integration_test.go.tmpl", Path: "tests/integration/order_repository_test.go", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/order_handler.go.tmpl", Path: "internal/infrastructure/http/order_handler.go", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/order_handler_test.go.tmpl", Path: "internal/infrastructure/http/order_handler_test.go", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
	{Source: "templates/postgres/http_errors.go.tmpl", Path: "internal/infrastructure/http/errors.go", Mode: 0o644, Ownership: OwnershipUser, Presets: map[string]bool{"postgres-api": true, "production-api": true, "event-driven-api": true}},
...
func Render(config project.Config, definition preset.Definition, resources []resource.Definition) ([]Artifact, error) {
	data := TemplateData{
		Config:    config,
		Preset:    definition,
		GoVersion: resolvedGoVersion(config.Project.GoVersion),
	}
