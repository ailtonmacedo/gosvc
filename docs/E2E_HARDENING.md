...
- `go build ./...`
- `make verify`
- `gosvc acceptance --json` (6/6 presets pass)
- `gosvc certify --mode static --require-real --json` (6/6 presets pass)
...
See `E2E_FIX_V16.md` for the current composable-presets/plugin-sandbox hardening baseline. Earlier E2E notes remain historical evidence.
